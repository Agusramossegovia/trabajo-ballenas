...
export default function Informacion () {
    ...
    <>
        <h1>Las ballenas</h1>
            <p>Las ballenas son los animales mas grandes que existen. Pertenencen a la comunidad de mamiferos marinos conocidos como cetáceos. No son peces porque tienen sangre caliente, respiran aire a traves de sus pulmones y dan a luz a crias vivas que se alimentan de leche maternas. 
            ...
            <br/>
            <p>Existen dos tipos principales de ballenas: las dentadas y las barbadas. Las barbadas tienen placas en forma de peines que están formadas por estructuras compuestas de pelos rígidos. Estos forman una red que filtra la comida del agua del mar. La gran mayoría de las grandes ballenas son barbadas y se alimentan fundamentalmente de minúsculas criaturas llamadas krill, parecidas a los camarones.
            Las ballenas dentadas son las orcas y los cachalotes. Las ballenas barbadas son las ballenas jorobadas y las ballenas azules. 
            </p>
        <Slider/>
            <br/>
        <h2>¿Porque son tan importantes para el ambiente?</h2>
            <p>Son fertilizadoras del océano, mitigadoras del cambio climático y promovedoras de biodiversidad.
        <br/>
